 ...
 * Layout: Asymmetric, staggered, full-bleed photography — MOBILE FIRST
 * i18n: EN / PT / ES toggle via LanguageContext
 */
...
// ── Icons ─────────────────────────────────────────────────────────────────────
const FacebookIcon  = () => <svg viewBox="0 0 24 24" fill="currentColor" style={{width:"20px",height:"20px",flexShrink:0}}><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>;
const InstagramIcon = () => <svg viewBox="0 0 24 24" fill="currentColor" style={{width:"20px",height:"20px",flexShrink:0}}><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>;
const TikTokIcon    = () => <svg viewBox="0 0 24 24" fill="currentColor" style={{width:"20px",height:"20px",flexShrink:0}}><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.77a4.85 4.85 0 01-1.01-.08z"/></svg>;
const YouTubeIcon   = () => <svg viewBox="0 0 24 24" fill="currentColor" style={{width:"20px",height:"20px",flexShrink:0}}><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>;
const SpotifyIcon   = () => <svg viewBox="0 0 24 24" fill="currentColor" style={{width:"20px",height:"20px",flexShrink:0}}><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"/></svg>;
const ChevronRight  = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" style={{width:"16px",height:"16px",flexShrink:0}}><path strokeLinecap="round" strokeLinejoin="round" d="M9 18l6-6-6-6"/></svg>;
const ExternalLink  = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{width:"16px",height:"16px",flexShrink:0}}><path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>;
  ...
  return (
    <div style={{ backgroundColor: "#0d0d0d", color: "#f0ede8", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav className="nav-inner" style={{
        ...
        <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(1rem, 4vw, 1.4rem)", letterSpacing: "0.05em", flexShrink: 0 }}>
          <span style={{ color: "#b5ff3a" }}>CALLUM BEATTIE</span>
          <span style={{ color: "#888", marginLeft: "0.5rem", fontSize: "0.85em" }}>FAN CLUB</span>
        </div>
        ...
        <div className="hidden md:flex" style={{ gap: "1.5rem", alignItems: "center" }}>
          {navItems.map(({ key, href }) => (
            <a key={key} href={href}
              style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "0.8rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "#888", textDecoration: "none", transition: "color 0.15s ease" }}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flexShrink: 0 }}>
          ...
          <button onClick={() => setMenuOpen(!menuOpen)}
            className="md:hidden"
            style={{ background: "none", border: "none", color: "#f0ede8", fontSize: "1.5rem", cursor: "pointer", padding: "0.25rem", lineHeight: 1 }}>
            {menuOpen ? "✕" : "☰"}
          </button>
        </div>
      </nav>
        ...
        <div style={{
          ...
          {navItems.map(({ key, href }) => (
            <a key={key} href={href} onClick={() => setMenuOpen(false)}
              style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "1rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "#f0ede8", textDecoration: "none", padding: "0.5rem 0", borderBottom: "1px solid #1a1a1a" }}>
              {t(key)}
            </a>
          ))}
          <a href={SOCIALS.callumWebsite} target="_blank" rel="noopener noreferrer" className="btn-lime" style={{ textAlign: "center", justifyContent: "center", marginTop: "0.5rem" }}>
            {t("nav.officialSite")}
          </a>
        </div>
      )}
      ...
      <section style={{ position: "relative", height: "100vh", minHeight: "600px", overflow: "hidden", display: "flex", alignItems: "flex-end", paddingBottom: "5rem" }}>
        ...
        <div className="hero-content" style={{ position: "relative", zIndex: 2, padding: "0 2rem", maxWidth: "900px", width: "100%" }}>
          <p className="ui-label animate-fade-up" style={{ color: "#b5ff3a", marginBottom: "1rem", opacity: 0, animationFillMode: "forwards" }}>
            {t("hero.tag")}
          </p>
          <h1 className="display-headline animate-fade-up delay-100" style={{ fontSize: "clamp(3.5rem, 15vw, 10rem)", lineHeight: "0.88", color: "#f0ede8", opacity: 0, animationFillMode: "forwards", marginBottom: "0.5rem" }}>
            CALLUM<br /><span style={{ color: "#b5ff3a" }}>BEATTIE</span>
          </h1>
          <h2 className="display-headline animate-fade-up delay-200" style={{ fontSize: "clamp(1.2rem, 4vw, 3rem)", color: "#888", opacity: 0, animationFillMode: "forwards", marginBottom: "2rem" }}>
            {t("hero.sub")}
          </h2>
          <div className="animate-fade-up delay-300 btn-group-mobile" style={{ display: "flex", gap: "1rem", flexWrap: "wrap", opacity: 0, animationFillMode: "forwards" }}>
      ...
      <div style={{ backgroundColor: "#b5ff3a", overflow: "hidden", padding: "0.75rem 0" }}>
        <div className="animate-ticker" style={{ display: "flex", whiteSpace: "nowrap", fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(0.9rem, 3vw, 1.2rem)", letterSpacing: "0.08em", color: "#0d0d0d", gap: "3rem" }}>
      ...
      {/* ── STATS ── */}
      <div ref={statsSection.ref} style={{ backgroundColor: "#161616", borderBottom: "1px solid #2a2a2a", padding: "3rem 1.5rem" }}>
        <div className="stats-grid" style={{ maxWidth: "1280px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.5rem", textAlign: "center" }}>
          {[
            ...
            <div key={i} style={{ opacity: statsSection.inView ? 1 : 0, transform: statsSection.inView ? "translateY(0)" : "translateY(20px)", transition: `all 0.5s ease ${i * 0.1}s` }}>
              <div className="display-headline stats-num" style={{ fontSize: "clamp(2rem, 8vw, 3rem)", color: "#b5ff3a", lineHeight: 1 }}>{num}</div>
              <div className="ui-label" style={{ color: "#888", marginTop: "0.4rem", fontSize: "clamp(0.6rem, 2vw, 0.75rem)" }}>{t(key)}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* ── ABOUT ── */}
      <section id="about" style={{ padding: "5rem 1.5rem", maxWidth: "1280px", margin: "0 auto" }}>
        <div ref={aboutSection.ref} className="about-grid">
          <div style={{ position: "relative", opacity: aboutSection.inView ? 1 : 0, transform: aboutSection.inView ? "translateX(0)" : "translateX(-40px)", transition: "all 0.7s ease" }}>
            <img src={ASSETS.callumPhoto} alt="Callum Beattie" className="about-photo" style={{ width: "100%", height: "600px", objectFit: "cover", objectPosition: "top", filter: "grayscale(20%)", display: "block" }} />
            <div style={{ position: "absolute", bottom: "-10px", right: "-10px", width: "100%", height: "100%", border: "3px solid #b5ff3a", zIndex: -1 }} />
          </div>
          <div style={{ opacity: aboutSection.inView ? 1 : 0, transform: aboutSection.inView ? "translateX(0)" : "translateX(40px)", transition: "all 0.7s ease 0.2s" }}>
            ...
            <h2 className="display-headline" style={{ fontSize: "clamp(2.5rem, 8vw, 5rem)", lineHeight: 0.9, marginBottom: "1.5rem", whiteSpace: "pre-line" }}>
              {t("about.headline")}
            </h2>
            <p style={{ fontFamily: "'Source Serif 4', serif", fontSize: "clamp(0.95rem, 3vw, 1.1rem)", lineHeight: 1.7, color: "#ccc", marginBottom: "1.5rem" }}>
              {t("about.p1")}
            </p>
            <p style={{ fontFamily: "'Source Serif 4', serif", fontSize: "clamp(0.95rem, 3vw, 1.1rem)", lineHeight: 1.7, color: "#ccc", marginBottom: "2rem" }}>
            ...
            <div className="btn-group-mobile" style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
      ...
      {/* ── ALBUM ── */}
      <section id="music" style={{ position: "relative", overflow: "hidden", backgroundImage: `url(${ASSETS.musicTexture})`, backgroundSize: "cover", backgroundPosition: "center", padding: "5rem 1.5rem" }}>
        ...
        <div ref={albumSection.ref} style={{ position: "relative", zIndex: 1, maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <h2 className="display-headline" style={{ fontSize: "clamp(2.5rem, 10vw, 7rem)", lineHeight: 0.9, marginBottom: "2.5rem", opacity: albumSection.inView ? 1 : 0, transform: albumSection.inView ? "translateY(0)" : "translateY(30px)", transition: "all 0.6s ease 0.1s" }}>
            {t("album.title")}
          </h2>
          <div style={{ opacity: albumSection.inView ? 1 : 0, transform: albumSection.inView ? "translateY(0)" : "translateY(30px)", transition: "all 0.6s ease 0.2s", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <iframe
            ...
            />
            <div className="btn-group-mobile" style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              <a href="https://callumbeattiemusic.com/home/" target="_blank" rel="noopener noreferrer" className="btn-outline-lime" style={{ justifyContent: "center" }}>
                {t("album.orderBtn")}
              </a>
            </div>
          </div>
      ...
      {/* ── OVO HYDRO ── */}
      <section className="hydro-section" style={{ position: "relative", height: "500px", overflow: "hidden", display: "flex", alignItems: "center" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, padding: "0 1.5rem", maxWidth: "800px" }}>
          <p className="ui-label" style={{ color: "#b5ff3a", marginBottom: "1rem" }}>{t("hydro.tag")}</p>
          <h2 className="display-headline" style={{ fontSize: "clamp(2rem, 7vw, 5rem)", lineHeight: 0.9, marginBottom: "1.5rem", whiteSpace: "pre-line" }}>
            {t("hydro.title")}
          </h2>
          <p style={{ fontFamily: "'Source Serif 4', serif", fontSize: "clamp(0.95rem, 3vw, 1.1rem)", color: "#ccc", maxWidth: "500px", lineHeight: 1.6 }}>
            {t("hydro.desc")}
          </p>
        </div>
      </section>
      ...
      {/* ── TOUR ── */}
      <section id="tour" style={{ padding: "5rem 1.5rem", maxWidth: "1280px", margin: "0 auto" }}>
        <div ref={tourSection.ref}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "2.5rem", flexWrap: "wrap", gap: "1rem" }}>
            <div>
              ...
              <h2 className="display-headline" style={{ fontSize: "clamp(2.5rem, 10vw, 6rem)", lineHeight: 0.9, opacity: tourSection.inView ? 1 : 0, transform: tourSection.inView ? "translateY(0)" : "translateY(20px)", transition: "all 0.6s ease 0.1s" }}>
                {t("tour.title")}
              </h2>
            </div>
            <a href="https://callumbeattiemusic.com/home/" target="_blank" rel="noopener noreferrer" className="btn-outline-lime" style={{ fontSize: "0.85rem", padding: "0.5rem 1.2rem" }}>
          ...
          <div style={{ borderTop: "1px solid #2a2a2a" }}>
            {TOUR_DATES.map((show, i) => (
              <div key={i}
                ...
                style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "1.25rem 0", borderBottom: "1px solid #2a2a2a", flexWrap: "wrap", opacity: tourSection.inView ? 1 : 0, transform: tourSection.inView ? "translateX(0)" : "translateX(-20px)", transition: `all 0.5s ease ${i * 0.07}s` }}
              >
                <span className="display-headline tour-date-label" style={{ fontSize: "clamp(0.85rem, 3vw, 1.1rem)", color: "#b5ff3a", minWidth: "120px", flexShrink: 0 }}>{show.date}</span>
                <div style={{ flex: 1, minWidth: "120px" }}>
                  <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: "clamp(0.85rem, 3vw, 1rem)" }}>{show.venue}</div>
                  <div className="ui-label" style={{ color: "#888", marginTop: "0.2rem" }}>{show.city}</div>
                </div>
                <a href={show.tickets} target="_blank" rel="noopener noreferrer" className="btn-lime tour-tickets-btn" style={{ fontSize: "0.85rem", padding: "0.5rem 1.2rem", whiteSpace: "nowrap" }}>
      ...
      {/* ── COMMUNITY ── */}
      <section id="community" style={{ position: "relative", overflow: "hidden", backgroundImage: `url(${ASSETS.fanCommunity})`, backgroundSize: "cover", backgroundPosition: "center", padding: "6rem 1.5rem" }}>
        ...
        <div ref={communitySection.ref} style={{ position: "relative", zIndex: 1, maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 className="display-headline" style={{ fontSize: "clamp(2.5rem, 9vw, 6rem)", lineHeight: 0.9, marginBottom: "1.5rem", whiteSpace: "pre-line", opacity: communitySection.inView ? 1 : 0, transform: communitySection.inView ? "translateY(0)" : "translateY(30px)", transition: "all 0.6s ease 0.1s" }}>
            {t("community.title").split("\n").map((line, i) =>
              i === 1 ? <span key={i} style={{ color: "#b5ff3a" }}>{line}</span> : <span key={i}>{line}<br /></span>
            )}
          </h2>
          <p style={{ fontFamily: "'Source Serif 4', serif", fontSize: "clamp(0.95rem, 3vw, 1.15rem)", lineHeight: 1.7, color: "#ccc", marginBottom: "2.5rem", opacity: communitySection.inView ? 1 : 0, transition: "opacity 0.6s ease 0.2s" }}>
            {t("community.desc")}
          </p>
          <div className="btn-group-mobile" style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap", opacity: communitySection.inView ? 1 : 0, transition: "opacity 0.6s ease 0.3s" }}>
      ...
      {/* ── FOLLOW ── */}
      <section id="follow" style={{ padding: "5rem 1.5rem", backgroundColor: "#0d0d0d" }}>
        <div ref={followSection.ref} style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <h2 className="display-headline" style={{ fontSize: "clamp(2.5rem, 9vw, 6rem)", lineHeight: 0.9, marginBottom: "1rem", whiteSpace: "pre-line", opacity: followSection.inView ? 1 : 0, transform: followSection.inView ? "translateY(0)" : "translateY(20px)", transition: "all 0.6s ease 0.1s" }}>
            {t("follow.title")}
          </h2>
          <p style={{ fontFamily: "'Source Serif 4', serif", fontSize: "clamp(0.95rem, 3vw, 1.1rem)", color: "#888", marginBottom: "2.5rem", maxWidth: "500px", opacity: followSection.inView ? 1 : 0, transition: "opacity 0.6s ease 0.2s" }}>
            {t("follow.desc")}
          </p>

          {/* Fan Club accounts */}
          <div style={{ marginBottom: "3rem" }}>
            <p className="ui-label" style={{ color: "#555", marginBottom: "1.25rem" }}>{t("follow.fanClubLabel")}</p>
            <div className="follow-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem" }}>
              {[
                ...
                <a key={i} href={url} target="_blank" rel="noopener noreferrer"
                  style={{ backgroundColor: "#161616", border: "1px solid #2a2a2a", padding: "1.25rem", display: "flex", flexDirection: "column", gap: "0.6rem", textDecoration: "none", color: "#f0ede8", transition: "all 0.2s ease", opacity: followSection.inView ? 1 : 0, transform: followSection.inView ? "translateY(0)" : "translateY(20px)", transitionDelay: `${0.1 + i * 0.07}s` }}
                ...
                >
                  ...
                  <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: "0.85rem", wordBreak: "break-all" }}>{handle}</div>
                  <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "0.75rem", color: "#888" }}>{t(followersKey)}</div>
          ...
          <div>
            <p className="ui-label" style={{ color: "#555", marginBottom: "1.25rem" }}>{t("follow.callumLabel")}</p>
            <div className="callum-follow-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "0.75rem" }}>
              {[
                ...
                <a key={i} href={url} target="_blank" rel="noopener noreferrer"
                  style={{ backgroundColor: "#0d0d0d", border: "1px solid #2a2a2a", padding: "1rem", display: "flex", alignItems: "center", gap: "0.75rem", textDecoration: "none", color: "#f0ede8", transition: "all 0.2s ease" }}
                ...
                >
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: "0.82rem", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{handle}</div>
                    <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "0.72rem", color: "#888" }}>{t(noteKey)}</div>
                  </div>
                  <div style={{ marginLeft: "auto", color: "#b5ff3a", flexShrink: 0 }}><ChevronRight /></div>
                </a>
              ))}
            </div>
          </div>
      ...
      {/* ── VIDEOS ── */}
      <section style={{ padding: "5rem 1.5rem", backgroundColor: "#111" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <p className="ui-label" style={{ color: "#b5ff3a", marginBottom: "0.75rem" }}>{t("videos.tag")}</p>
          <h2 className="display-headline" style={{ fontSize: "clamp(2.5rem, 9vw, 6rem)", lineHeight: 0.9, marginBottom: "2.5rem" }}>{t("videos.title")}</h2>
          <div className="videos-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1.25rem" }}>
            {[
              ...
              >
                <div style={{ position: "relative", paddingBottom: "56.25%", overflow: "hidden" }}>
                  ...
                  <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(0,0,0,0.3)" }}>
                    <div style={{ width: "52px", height: "52px", backgroundColor: "#b5ff3a", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <svg viewBox="0 0 24 24" fill="#0d0d0d" style={{ width: "22px", height: "22px", marginLeft: "3px" }}><path d="M8 5v14l11-7z"/></svg>
                    </div>
                  </div>
                </div>
                <div style={{ padding: "1rem" }}>
                  <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: "0.9rem", marginBottom: "0.3rem" }}>{t(titleKey)}</div>
      ...
      {/* ── FINAL CTA ── */}
      <section style={{ padding: "6rem 1.5rem", backgroundColor: "#0d0d0d", borderTop: "1px solid #2a2a2a", textAlign: "center" }}>
        <p className="ui-label" style={{ color: "#b5ff3a", marginBottom: "1rem" }}>{t("cta.tag")}</p>
        <h2 className="display-headline" style={{ fontSize: "clamp(2.5rem, 10vw, 8rem)", lineHeight: 0.88, marginBottom: "1.5rem", whiteSpace: "pre-line" }}>
          {t("cta.title").split("\n").map((line, i) =>
            i === 2
        ...
        <p style={{ fontFamily: "'Source Serif 4', serif", fontSize: "clamp(0.95rem, 3vw, 1.15rem)", color: "#888", maxWidth: "500px", margin: "0 auto 2.5rem", lineHeight: 1.7 }}>
          {t("cta.desc")}
        </p>
        <div className="btn-group-mobile" style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ backgroundColor: "#0a0a0a", borderTop: "1px solid #1a1a1a", padding: "2.5rem 1.5rem" }}>
        <div className="footer-inner" style={{ maxWidth: "1280px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1.5rem" }}>
          <div>
            <div className="display-headline" style={{ fontSize: "clamp(1.2rem, 5vw, 1.8rem)", color: "#f0ede8", marginBottom: "0.3rem" }}>
              CALLUM BEATTIE <span style={{ color: "#b5ff3a" }}>FAN CLUB</span>
            </div>
            <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "0.75rem", color: "#555" }}>
              {t("footer.disclaimer")}
            </p>
          </div>
          <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
            {[
              ...
              <a key={i} href={url} target="_blank" rel="noopener noreferrer"
                style={{ color: "#555", transition: "color 0.15s ease", display: "flex", padding: "0.25rem" }}
        ...
        <div className="footer-bottom" style={{ maxWidth: "1280px", margin: "1.5rem auto 0", borderTop: "1px solid #1a1a1a", paddingTop: "1.25rem", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "0.75rem" }}>
          <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "0.72rem", color: "#444" }}>{t("footer.copyright")}</p>
          <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "0.72rem", color: "#444" }}>#callumbeattie #wearestars #indi</p>
        </div>
      </footer>
    </div>
  );
